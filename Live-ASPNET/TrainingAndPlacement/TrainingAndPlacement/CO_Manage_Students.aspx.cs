...
{
    public partial class CO_Manage_Students : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Session["Co_Department"] != null && Session["Co_Department"] != "" && Session["Co_Department"] != string.Empty && Session["Co_Department"] != "&nbsp;")
                {
                    btnShow_All.Visible = false;
                    bind_Department();
                    ddlCourse.SelectedValue = Session["Co_Department"].ToString();
                }
            }
        }
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (Session["User"].ToString() == "Coordinator")
                {
                    if (Session["Co_Department"] != null)
                    {
                        if (ddlCourse.SelectedValue == Session["Co_Department"].ToString())
                        {
                            bel_mem.bel_Academic_Year = ddlAcademic.SelectedItem.Text;
                            bel_mem.bel_Course_Name = ddlCourse.SelectedValue;
                            DataSet ds = bal_mem.bindStudent_Year_Dept_wise(bel_mem);
                        ...
                        {
                            string script = "alert(\"Please Select Valid Course!\");"; ScriptManager.RegisterStartupScript(this, GetType(), "ServerControlScript", script, true);

...
{
    public partial class Coordinator_Profile : System.Web.UI.Page
    {
        ...
        {
            if (Session["Co_Id"] != null && Session["Co_Id"] != "" && Session["Co_Id"] != string.Empty && Session["Co_Id"] != "&nbsp;")
            {
                bind_Department();
                search();
            }
        ...
        protected void search()
        {
            ...
            try
            {
                bel_er.bel_emp_id = Session["Co_Id"].ToString();
                ...
                {
                    string script = "alert(\"Coordinator Id Not Found In Database!\");"; ScriptManager.RegisterStartupScript(this, GetType(), "ServerControlScript", script, true);
                }
            }
            catch (Exception ex)
            {

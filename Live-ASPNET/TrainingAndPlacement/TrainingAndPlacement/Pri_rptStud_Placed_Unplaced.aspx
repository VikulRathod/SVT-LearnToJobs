<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Pri_rptStud_Placed_Unplaced.aspx.cs" Inherits="TrainingAndPlacement.Pri_rptStud_Placed_Unplaced" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">All Student List</a></li>
        </ol>
    </section>
                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <div class="box box-default">
                            <div class="box-header with-border">
                                <div class="col-md-1">
                                    <asp:RadioButton ID="RadioAll" GroupName="Apply" runat="server" Text="All" AutoPostBack="true" OnCheckedChanged="RadioAll_CheckedChanged" />
                                </div>
                                <div class="col-md-2">
                                    <asp:RadioButton ID="RadioYearly" GroupName="Apply" runat="server" Text="Yearly" AutoPostBack="true" OnCheckedChanged="RadioYearly_CheckedChanged" />
                                </div>
                            </div>
                            <!-- /.box-body -->
                        </div>

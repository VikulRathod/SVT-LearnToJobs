<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Student.Master" CodeBehind="Update_Student.aspx.cs" Inherits="TrainingAndPlacement.Update_Student" %>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-danger">
                    <div class="box-header with-border">
                        ...
                        <div class="col-md-6 ser-fet" align="right">
                            <asp:Label ID="Approval" runat="server" Style="background-color: #FFB7B7; padding: 5 10 5 10; margin: 0 10;"></asp:Label>
                            <asp:Label ID="Placed" runat="server" Style="background-color: #FFB7B7; padding: 5 10 5 10; margin: 0 10;"></asp:Label>
                        </div>
                    </div>
                    <div class="box-body">
                        <!-- Member Full Name -->
                        <div class="form-group">
                            ...
                            <div class="col-md-4 ser-fet">
                                <asp:Label class="form-control" ID="txtAcadmic" runat="server" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox class="form-control" ID="txtClass_ID" runat="server" placeholder="Enter Class ID " />
                            </div>
                            <div class="col-md-2 ser-fet">
                                <label>Roll No.:</label>
                            </div>
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox class="form-control" ID="txtRoll_No" runat="server" placeholder=" Enter Roll No." />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-2 ser-fet">
                            ...
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox class="form-control" ID="txtStudent_Name" runat="server" placeholder="Enter Student Name*: " />
                            </div>
                            <div class="col-md-2 ser-fet">
                                <label>Email *:</label>
                            </div>
                            <div class="col-md-4 ser-fet" data-toggle="tooltip" title="Email ID It would be Username!!!">
                                <asp:Label class="form-control" ID="txtEmail" runat="server" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox class="form-control" ID="txtcontact" runat="server" placeholder="Enter Contact No " />
                            </div>
                            <div class="col-md-2 ser-fet">
                            ...
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox class="form-control" ID="txtalt_No" runat="server" placeholder="Enter Alt Contact No *" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-2 ser-fet">
                            ...
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox class="form-control" ID="txtMother_Name" runat="server" placeholder="Enter Mother Name:" />
                            </div>
                            <div class="col-md-2 ser-fet">
                                <label>Gender:</label>
                            </div>
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:DropDownList ID="ddlGender" runat="server" class="form-control">
                                    <asp:ListItem Value="Both">---Select---</asp:ListItem>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox class="form-control" ID="txtdob" runat="server" placeholder="Enter Date of Birth " />
                            </div>
                            <div class="col-md-2 ser-fet">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox class="form-control" ID="txtAdmission_Date" runat="server" placeholder="Select DOB*" required="required"></asp:TextBox>
                            </div>
                            <div class="col-md-2 ser-fet">
                                <label>Address:</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox class="form-control" ID="tstNationality" runat="server" placeholder="Enter Nationality "></asp:TextBox>
                            </div>
                            <div class="col-md-2 ser-fet">
                            ...
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox class="form-control" ID="txtDomicile" runat="server" placeholder="Enter Domicile"></asp:TextBox>
                            </div>
                        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox class="form-control" ID="txtDesignation" runat="server" placeholder="Enter Designation"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter Parent Name" />
                            </div>
                            <div class="col-md-2 ser-fet">
                            ...
                            <div class="col-md-4 ser-fet">
                                ...
                                <asp:TextBox class="form-control" ID="txtIncome" runat="server" placeholder="Annual Income: *" MaxLength="10" />
                            </div>
                        </div>
                            ...
                            <div class="bs-example animated wow fadeInLeft" data-wow-duration="1000ms" data-example-id="contextual-table" style="border: 1px solid #eee; font-family: Source Sans Pro; overflow-x: scroll;">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr class="active">
                                            <th scope="row">SSC</th>
                                            <td><asp:TextBox class="form-control" ID="txt10board" runat="server"/></td>
                                            <td><asp:TextBox class="form-control" ID="txt10sub" runat="server" /></td>
                                            <td style="width: 20px;">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-footer">
                        <div class="col-md-7 ser-fet">
                            Befor Completion Student Update Please Check All Data.
                        </div>
                        <div class="col-md-3">

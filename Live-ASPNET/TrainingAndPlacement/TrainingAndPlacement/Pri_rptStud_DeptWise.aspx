<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Pri_rptStud_DeptWise.aspx.cs" Inherits="TrainingAndPlacement.Pri_rptStud_DeptWise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>Department Wise Student List
        <small>Reports</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
            <li><a href="#">Student Reports</a></li>
            <li><a href="#">Department Wise Student List</a></li>
        </ol>
    </section>
                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <div class="box box-default">
                            <div class="box-header with-border">
                                <div class="col-md-3">
                                    <asp:RadioButton ID="RadioDept" GroupName="Apply" runat="server" Text="Department" AutoPostBack="true" OnCheckedChanged="RadioDept_CheckedChanged" />
                                </div>
                                <div class="col-md-3">
                                    <asp:RadioButton ID="Radioyear_dept" GroupName="Apply" runat="server" Text="Yearly & Dept" AutoPostBack="true" OnCheckedChanged="Radioyear_dept_CheckedChanged" />
                                </div>

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin_Placement.Master" CodeBehind="Student_Apply_Drive_Extra.aspx.cs" Inherits="TrainingAndPlacement.Student_Apply_Drive_Extra" %>
                ...
                <div class="box box-info ">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <asp:LinkButton ID="btnApply_Drive" class="btn btn-primary" runat="server" OnClick="btnApply_Drive_Click"><i class="fa fa-Apply"></i> Apply Now!</asp:LinkButton>
                            </div>
                            <%--</div>--%>
                        </div>
                    </div>

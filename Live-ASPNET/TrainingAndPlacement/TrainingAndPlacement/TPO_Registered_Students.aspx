<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin_Placement.Master" CodeBehind="TPO_Registered_Students.aspx.cs" Inherits="TrainingAndPlacement.TPO_Registered_Students" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Registered Students Information</a></li>
      </ol>
    </section>
   ...
   <section class="content">
        <div class="row">
             <div class="col-md-12">
                ...
                <div class="box-header with-border">
                    <div class="col-md-9">
                        <h3 class="box-title">List of Registered Students </h3>
                    </div>
                ...
                <div class="box-body" align="center" style="font-family: Source Sans Pro; overflow-x: scroll; height:600px; width:100%">
                    <div class="form-group" >
                        <asp:GridView ID="gvStudent" CssClass="table table-striped table-bordered table-hover" 
                            runat="server" CellPadding="3" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" 
                            BorderStyle="None" BorderWidth="1px"  DataKeyNames="Company_Name" EnableModelValidation="True" 
                            OnRowCreated="gvStudent_RowCreated" >
                            <Columns>      
                                ...
                                <asp:BoundField DataField="AppliedDate" HeaderText="Applied Date" ReadOnly="True"/>
                                <asp:BoundField DataField="Drive_Title" HeaderText="Drive Title" ReadOnly="True"/>
                                <asp:BoundField DataField="Round" HeaderText="Round No." ReadOnly="True"/>
                            </Columns>

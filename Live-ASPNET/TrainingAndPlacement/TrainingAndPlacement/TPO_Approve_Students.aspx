<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin_Placement.Master" CodeBehind="TPO_Approve_Students.aspx.cs" Inherits="TrainingAndPlacement.TPO_Approve_Students" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="content-header">
      <h1>
        Approve  and Disapprove Students
        <small>Information</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="Coordinator_Profile.aspx"><i class="fa fa-home"></i> Home</a></li>
        <li><a href="Deactiveted.aspx">Approve  and Disapprove Students</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-default">
            <div class="box-header with-border">
                    ...
                    <div class="col-md-2 ser-fet">      
                    <asp:LinkButton ID="btnShow_All" class="btn btn-primary" runat="server" ValidationGroup="staff" OnClick="btnShow_All_Click"><i class="fa fa-search"></i> Show All</asp:LinkButton>
                </div>
           </div>
        <!-- /.box-body -->
            <%--<div class="box-footer">
                <div class="col-md-4 ">
                    <div class="input-group">
                        <div class="input-group-btn">
                            <button type="button" class="btn btn-danger">Total Students: </button>
                        </div>
                        <asp:Label ID="txtTotal" runat="server" class="form-control"/>
                    </div>
                </div>
                <div class="col-md-4 ">
                    <div class="input-group">
                        <div class="input-group-btn">
                            <button type="button" class="btn btn-danger">Approved Students: </button>
                        </div>
                        <asp:Label ID="txtApproved" runat="server" class="form-control"/>
                    </div>
                </div>
                <div class="col-md-4 ">
                    <div class="input-group">
                        <div class="input-group-btn">
                            <button type="button" class="btn btn-danger">Disapproved Students: </button>
                        </div>
                        <asp:Label ID="txtDisapproved" runat="server" class="form-control"/>
                    </div>
                </div>
             </div>--%>
      </div>
        ...
        <div class="box box-info ">
                ...
                <div class="box-header with-border">
                    ...
                    <div class="col-md-3 ser-fet"">      
                        <asp:LinkButton ID="Approve" class="btn btn-primary" runat="server" ValidationGroup="staff" OnClick="Approve_Click"><i class="fa fa-search"></i> Approve</asp:LinkButton>
                    </div>
            <div class="col-md-3 ser-fet">      
                        <asp:LinkButton ID="Disapprove" class="btn btn-primary" runat="server" ValidationGroup="staff" OnClick="Disapprove_Click"><i class="fa fa-search"></i> Disapprove</asp:LinkButton>
                    </div>
               </div>
                <!-- /.box-header -->

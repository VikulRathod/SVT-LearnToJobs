<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin_Placement.Master" CodeBehind="Delete_Student.aspx.cs" Inherits="TrainingAndPlacement.Delete_Student" %>
        ...
        <div class="box box-info ">
                ...
                <div class="box-header with-border">
                    ...
                    <div class="col-md-3 ser-fet"">      
                        <asp:LinkButton ID="btnDelete" class="btn btn-primary" runat="server" ValidationGroup="staff" OnClick="btnDelete_Click"><i class="fa fa-search"></i> Delete</asp:LinkButton>
                    </div>
               </div>
                <!-- /.box-header -->

<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Pri_rptStud_DriveWise.aspx.cs" Inherits="TrainingAndPlacement.Pri_rptStud_DriveWise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>Drive Wise Student List
        <small>Reports</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
            <li><a href="#">Student Reports</a></li>
            <li><a href="#">Drive Wise Student List</a></li>
        </ol>
    </section>
                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <div class="box box-default">
                            <div class="box-header with-border">
                                <div class="col-md-3">
                                    <asp:RadioButton ID="RadioDrive" GroupName="Apply" runat="server" Text="Drive" AutoPostBack="true" OnCheckedChanged="RadioDrive_CheckedChanged" />
                                </div>
                                <div class="col-md-3">
                                    <asp:RadioButton ID="Radioyear_drive" GroupName="Apply" runat="server" Text="Yearly & Drive" AutoPostBack="true" OnCheckedChanged="Radioyear_drive_CheckedChanged" />
                                </div>
                            </div>
                            <!-- /.box-body -->
                        </div>
                            ...
                            <asp:Panel ID="Drive" runat="server">
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <asp:DropDownList ID="ddlCompany_ID" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlCompany_ID_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                    <br />
                                </div>
                                <div class="col-md-4">

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" MasterPageFile="~/Admin_Placement.Master" CodeBehind="Student.aspx.cs" Inherits="TrainingAndPlacement.Student" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <div class="form-group">
                            ...
                            <div class="col-md-3" data-toggle="tooltip" title="Only excel files allowed.!!!">
                                <asp:FileUpload ID="FileUpload1" class="btn btn-primary" runat="server" /><br />
                            </div>
                            <div class="col-md-3">
                                <asp:LinkButton ID="btnUpload" class="btn btn-primary" runat="server" ValidationGroup="staff1" AutoPostBack="true" OnClick="btnUpload_Click"><i class="fa fa-upload"></i> Upload File</asp:LinkButton>
                            </div>
                            <div class="col-md-3" data-toggle="tooltip" title="Befor Completion Student Save Please Check All Data.!!!">
                                <asp:LinkButton ID="btnSave" class="btn btn-primary" runat="server" ValidationGroup="staff1" AutoPostBack="true" OnClick="btnSave_Click"><i class="fa fa-save"></i> Save Now!</asp:LinkButton>
                            </div>
                            <div class="col-md-3">
                                <asp:LinkButton ID="LinkButton1" class="btn btn-primary" runat="server" PostBackUrl="~/TPO_Add__Update_Student.aspx"><i class="fa fa-user-plus"></i> Add Individually</asp:LinkButton>
                            </div>
                            <div class="col-md-3" data-toggle="tooltip" title="Befor Completion Student Save Please Check All Data.!!!">
                                <asp:LinkButton ID="btnsend" class="btn btn-primary" runat="server" ValidationGroup="staff1" AutoPostBack="true" OnClick="btnsend_Click"><i class="fa fa-send"></i> Send Notification</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
                ...
                <div class="box box-info ">
                    ...
                    <div class="box-header with-border">
                        <div class="col-md-6">
                            <h3 class="box-title">Complate Student Registration Data View</h3>
                        </div>
                        <div class="col-md-3" data-toggle="tooltip" title=" Do not make any changes in column name of excel sheet while preparing students list. Column names are case sensitive. Keep it same as in demo file.!!!">
                            <asp:HyperLink ID="linkblack" runat="server" Text="Download Blank Excel Sheet" />
                        </div>
                        <div class="col-md-3">
                            <asp:HyperLink ID="linkdemo" runat="server" Text="Download Demo Student List" />
                        </div>
                    </div>
                    <!-- /.box-header -->
                        ...
                        <div class="form-group">
                            <asp:GridView ID="gmStudent_Regi" CssClass="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Gap_Year" DataField="Gap_Year" />

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Coordinator.Master" CodeBehind="Co_Place_Unplace_list.aspx.cs" Inherits="TrainingAndPlacement.Co_Place_Unplace_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>Student Placed / Unplaced List
        <small>Reports</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
            <li><a href="#">Student Placed / Unplaced List</a></li>
        </ol>
    </section>
                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <div class="box box-default">
                            <div class="box-header with-border">
                                <div class="col-md-4">
                                    <asp:RadioButton ID="RadioDept" GroupName="Apply" runat="server" Text="Department Wise" AutoPostBack="true" OnCheckedChanged="RadioDept_CheckedChanged" />
                                </div>
                                <div class="col-md-4">
                                    <asp:RadioButton ID="Radioyear_dept" GroupName="Apply" runat="server" Text="Yearly & Dept Wise" AutoPostBack="true" OnCheckedChanged="Radioyear_dept_CheckedChanged" />
                                </div>
                        ...
                        <div class="form-group">
                            <asp:Panel ID="Department" runat="server">
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <div class="input-group-btn">
